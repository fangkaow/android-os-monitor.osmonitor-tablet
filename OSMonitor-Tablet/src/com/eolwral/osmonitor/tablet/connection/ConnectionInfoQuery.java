...
public class ConnectionInfoQuery extends Thread
{

	private static ConnectionInfoQuery singletone = null;

	public static ConnectionInfoQuery getInstance()
	{
		if(singletone == null)
		{
			singletone = new ConnectionInfoQuery();
            singletone.start();
		}
		return singletone;
	}    
